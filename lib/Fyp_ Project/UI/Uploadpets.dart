...
class UploadPets extends StatefulWidget {
  const UploadPets({Key? key}) : super(key: key);

  @override
  State<UploadPets> createState() => _UploadPetsState();
}

class _UploadPetsState extends State<UploadPets> {
  @override
